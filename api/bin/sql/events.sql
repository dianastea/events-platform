...
INSERT INTO events(name, group_name, time, description) 
VALUES ('The Origins of the Universe', 'ABA', '00:11:15', 'An introduction to space science and the wonders it has to hold. Go space!'); 

INSERT INTO events(name, group_name, time, description) 
VALUES ('STEM World', 'ABA', '00:11:15', 'An introduction to space science and the wonders it has to hold. Go space!'); 
